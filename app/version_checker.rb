...
[AmcrestCamPlatform, BlueIrisPlatform, DockerPlatform, HassAddonsPlatform, HassOSPlatform, PfSensePlatform, PlexPlatform, TasmotaPlatform, UniFiPlatform].each do |platform_class|
